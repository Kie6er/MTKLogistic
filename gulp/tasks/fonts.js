			...
			if(!fs.existsSync(fontsFile)) {
				...
				for (var i = 0; i < fontsFiles.length; i++) {
					...
					if (newFileOnly !== fontFileName) {
						...
						fs.appendFile(fontsFile, `@font-face {\n\tfont-family: ${fontName};\n\tfont-display: swap;\n\tsrc: url("../fonts/${fontFileName}.woff2") format ("woff2"), url("../fonts/${fontFileName}.ttf") format ("ttf"), url("../fonts/${fontFileName}.otf") format ("otf"), url("../fonts/${fontFileName}.woff") format ("woff");\n\tfont-weight: ${fontWeight};\n\tfont-style: normal;}\r\n`, cb);
